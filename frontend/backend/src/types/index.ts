...
export interface Attachment {
  ...
  confirmationStep?: ConfirmationStep;  // Which confirmation step this attachment belongs to
  holdUntilCompletion?: boolean;        // If true, hide from other party until deal completes
  notes?: string;                        // Notes accompanying the attachment
  createdAt: Date;
  updatedAt: Date;
}
...
// Organization Service Type Settings
