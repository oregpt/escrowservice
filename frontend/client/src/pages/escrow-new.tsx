...
const STEP_TITLES = [
  ...
  { title: 'Counterparty', description: 'Define who will fulfill this deal.' },
  { title: 'Terms (Optional)', description: 'Add optional terms, description, and expiry settings.' },
...
export default function EscrowNew() {
  ...
  // Step 3: Terms (collapsible sections)
  ...
  const handleNext = () => {
    ...
    if (step === 1) {
      ...
      // Skip trafficAmountBytes (auto-calculated) and domainId (optional, auto-defaulted)
      const requiredFields = Object.keys(metadataSchema);
      for (const field of requiredFields) {
        if (!metadataValues[field] && field !== 'trafficAmountBytes' && field !== 'domainId') {
          toast({
            title: "Required",
  ...
  const handleSubmit = async () => {
    try {
      ...
      toast({
        title: "Deal Created",
        description: `Deal ${result?.id?.slice(0, 8)}... has been created successfully.`,
      });
      ...
      <PageContainer className="max-w-3xl">
            ...
            <CardContent className="space-y-6">
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <div className="text-sm text-muted-foreground">Create a new deal from scratch</div>
                </div>
              </Button>
              ...
              {!templatesLoading && userTemplates.length === 0 && platformTemplates.length === 0 && (
                <p className="text-center text-sm text-muted-foreground py-4">
                  No templates yet. Create a deal and save it as a template for quick reuse.
                </p>
              )}
            </CardContent>
          </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
              ...
              <>
                ...
                <div className="bg-blue-50/50 border border-blue-100 rounded-lg p-4 flex gap-3">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-sm text-blue-700">Funds are held securely until you verify the service delivery.</p>
                  </div>
                </div>
              </>
            )}
            ...
            {step === 2 && (
              <>
                <div className="space-y-4">
                  <Label className="text-base">Who will fulfill this deal?</Label>
                  <RadioGroup
                  ...
                  >
                    ...
                    >
                      ...
                      <p className="text-sm text-muted-foreground pl-6">
                        Anyone can view and accept this deal.
                      </p>
                    </Label>
                    ...
                    >
                      ...
                      <p className="text-sm text-muted-foreground pl-6">
                        Only the specified entity can accept. They'll receive a notification to join the deal.
                      </p>
                    </Label>
                  </RadioGroup>
                </div>
                  ...
                  <div className="space-y-4 border-t pt-6">
                    ...
                    {specificType === 'email' && (
                      <div className="space-y-4 pt-2">
                        ...
                        <div className="space-y-2">
                          ...
                          />
                          <p className="text-xs text-muted-foreground">
                            Only this specific person will see and can accept this deal.
                          </p>
                        </div>
                      </div>
                    )}
                    ...
                    {specificType === 'organization' && (
                      <div className="space-y-2 pt-2">
                        ...
                        />
                        <p className="text-xs text-muted-foreground">
                          Ask the counterparty for their Organization ID (found on their Balances page). Any member of that organization can accept the deal.
                        </p>
                      </div>
                    )}
                  </div>
                  ...
                  <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 flex gap-3">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-sm text-amber-700">
                        This deal will be visible to registered providers. The first qualified provider to accept will become the counterparty.
                      </p>
                    </div>
                  </div>
                )}
                ...
                <div className="space-y-4 border-t pt-6">
                  ...
                  >
                    ...
                    >
                      ...
                      <p className="text-xs text-muted-foreground pl-6">
                        Platform admin handles all disputes. Simplest option for most deals.
                      </p>
                    </Label>
                  ...
                  {arbiterType === 'organization' && (
                    <div className="space-y-2 pt-2 pl-6">
                      ...
                      />
                      <p className="text-xs text-muted-foreground">
                        Any admin of this organization can cancel or force-complete the deal if a dispute arises.
                      </p>
                    </div>
                  )}
                  ...
                  {arbiterType === 'person' && (
                    <div className="space-y-2 pt-2 pl-6">
                      ...
                      />
                      <p className="text-xs text-muted-foreground">
                        This person can cancel or force-complete the deal if a dispute arises.
                      </p>
                    </div>
                  )}
                </div>
            ...
            {/* Step 3: Terms (Optional - Collapsible) */}
            {step === 3 && (
              <div className="space-y-3">
                <div className="bg-blue-50 border border-blue-100 rounded-lg p-3 mb-4">
                  <p className="text-sm text-blue-800">
                    <strong>This step is optional.</strong> You can expand any section below to add details, or skip directly to Review.
                  </p>
                </div>

                {/* Description Section */}
                <Collapsible open={descriptionOpen} onOpenChange={setDescriptionOpen}>
                  <CollapsibleTrigger className="flex items-center justify-between w-full p-3 bg-slate-50 hover:bg-slate-100 rounded-lg border transition-colors">
                    <div className="flex items-center gap-2">
                      <FileText className="h-4 w-4 text-slate-500" />
                      <span className="font-medium text-sm">Description</span>
                      {description && <Badge variant="secondary" className="text-xs">Added</Badge>}
                    </div>
                    <ChevronDown className={`h-4 w-4 text-slate-500 transition-transform ${descriptionOpen ? 'rotate-180' : ''}`} />
                  </CollapsibleTrigger>
                ...
                <Collapsible open={termsOpen} onOpenChange={setTermsOpen}>
                  <CollapsibleTrigger className="flex items-center justify-between w-full p-3 bg-slate-50 hover:bg-slate-100 rounded-lg border transition-colors">
                    <div className="flex items-center gap-2">
                      ...
                      {terms && <Badge variant="secondary" className="text-xs">Added</Badge>}
                    </div>
                    <ChevronDown className={`h-4 w-4 text-slate-500 transition-transform ${termsOpen ? 'rotate-180' : ''}`} />
                  </CollapsibleTrigger>
                  <CollapsibleContent className="pt-3">
                    <div className="space-y-2 pl-1">
                      <Textarea
                ...
                <Collapsible open={expiryOpen} onOpenChange={setExpiryOpen}>
                  <CollapsibleTrigger className="flex items-center justify-between w-full p-3 bg-slate-50 hover:bg-slate-100 rounded-lg border transition-colors">
                    <div className="flex items-center gap-2">
                      ...
                      <Badge variant="outline" className="text-xs">{expiryDays === '7d' ? '7 Days (default)' : expiryDays}</Badge>
                    </div>
                    <ChevronDown className={`h-4 w-4 text-slate-500 transition-transform ${expiryOpen ? 'rotate-180' : ''}`} />
                  </CollapsibleTrigger>
                  <CollapsibleContent className="pt-3">
                    <div className="space-y-2 pl-1">
        ...
        <Dialog open={showSaveTemplateDialog} onOpenChange={setShowSaveTemplateDialog}>
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                Save this deal configuration as a template for quick reuse.
              </DialogDescription>
            </DialogHeader>
